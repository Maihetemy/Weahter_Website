...
export default function Home() {
  return (
    <div className="tracking-wide flex flex-col px-5 md:flex-row bg-primary-light  dark:bg-primary-dark">
      <div className="w-full lg:w-1/4 h-max py-3">
        <CurrentWeather />
      </div>
      <div className="flex flex-1 h-full px-5">
        <div className="hidden md:inline-block max-h-dvh min-h-[1em] w-[1px] self-stretch bg-neutral-100 dark:bg-white/10" />
      </div>
